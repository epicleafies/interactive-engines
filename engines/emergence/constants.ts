...
export const CONSTANTS: readonly ConstantSpec[] = [
  ...
  { name: "SEED_CAP", class: "tuned", status: "tbd", denomination: "share", isThreshold: true, proposed: null,
    note: "cap on the seeded prior fraction; registered <= DOM_THRESHOLD - D5_MARGIN; asserted at setup (G7)." },
  { name: "D5_MARGIN", class: "tuned", status: "tbd", denomination: "share", isThreshold: true, proposed: null,
    note: "D5 seed headroom; §2.4 validity precondition SEED_CAP <= DOM_THRESHOLD - D5_MARGIN; home ruled, value TBD/C0 (D-056)." },
